...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += X[:,None].dot(hidden_error_term[:,None].T) #TODO: AB: check the sign
        # Weight step (hidden to output)
        delta_weights_h_o += hidden_outputs[:, None].dot(output_error_term[:, None].T) #TODO: AB: check the sign
